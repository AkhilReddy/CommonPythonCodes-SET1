...
print s
• This violates the data hiding aspect of an object, and 
exposes internal representation
– If I were to change how I want to represent a grade book, I 
should only need to change the methods within that object, not 
